...
{
    internal class Th12ScoreView
    {
        public static string[] Th12PlayersList = GamePlayers.GetGamePlayers(GameIndex.Th12).Split(',');
                    ...
                    using (decodedData)
                    {
                        ...
                        for (int k = 0; k < 6; k++)
                        {
                            ...
                            while (i < max)
                            {
                                ...
                                scoreRecordList.Player = Th12PlayersList[k];
        ...
        public static SpellCardRecordList GetAllSpellCardRecord(int cardId, byte[] data, bool displayUnchallengedCard)
        {
            ...
            int challengeSanaeA = int.Parse(cardDataSanaeA.Challenge);
            int challengeSanaeB = int.Parse(cardDataSanaeB.Challenge);
            ...
            int getSanaeA = int.Parse(cardDataSanaeA.Get);
            int getSanaeB = int.Parse(cardDataSanaeB.Get);
